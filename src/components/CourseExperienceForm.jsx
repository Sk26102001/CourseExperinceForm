...
//             />
//           </div>
//           {/* REMOVED mx-auto TO ALIGN LEFT, KEPT max-w-sm FOR CONSISTENT LOOK */}
//           <div className="max-w-sm w-85">
//             {/* PHONE IS NOW MANDATORY */}
//             <MotionInput
//               label="Phone Number"
//               id="phone"
...
// Define styles for the entire app container
// FIX APPLIED HERE: Removed 'flex items-center justify-center' 
// to prevent vertical centering, which causes content jumping on tall forms.
const AppContainer = ({ children }) => (
  <div className="min-h-screen bg-gradient-to-br from-amber-50 to-orange-100 p-4 font-['Inter']">
    {children}
  </div>
);
...
const CourseExperienceForm = () => {
  ...
  return (
    <AppContainer>
      <motion.div
        // The mx-auto class here handles horizontal centering correctly now.
        className="max-w-3xl w-full mx-auto p-8 bg-white shadow-2xl rounded-2xl border-4 border-orange-200"
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.5 }}
      >
        ...
        <form onSubmit={handleSubmit}>
          ...
          {/* REMOVED mx-auto TO ALIGN LEFT, KEPT max-w-sm FOR CONSISTENT LOOK */}
          <div className="max-w-sm w-full lg:w-85">
            {/* PHONE IS NOW MANDATORY */}
            <MotionInput
              label="Phone Number"
              id="phone"
